...
module "ingress" {
  ...
  # e.g., if domain_name is devlab405.click and app_subdomain is "app", 
  # the full domain will be app.devlab405.click
  ...
  # If managing Route53 in Terraform, provide the hosted zone name (e.g., devlab405.click)
