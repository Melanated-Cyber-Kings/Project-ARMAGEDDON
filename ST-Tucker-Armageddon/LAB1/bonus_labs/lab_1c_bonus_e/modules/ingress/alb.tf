...
resource "aws_lb" "app_alb" {
  ...
  # For Lab-1C , we want internet-facing ALB. The default is "internet-facing", so we can omit the scheme or set it explicitly.
  ...
  # For Lab-1C , we want internet-facing ALB. Set internal to false for internet-facing, true for internal. 
