...
# resource "aws_security_group_rule" "alb_ingress_http_from_cf" {
#   type              = "ingress"
#   from_port         = 80
#   to_port           = 80
#   protocol          = "tcp"
#   prefix_list_ids   = [data.aws_ec2_managed_prefix_list.cloudfront_origin_facing.id] # <--- CLOAKING
#   security_group_id = aws_security_group.chewbacca_alb_sg01.id
# }

# resource "aws_security_group_rule" "alb_ingress_https_from_cf" {
#   type              = "ingress"
#   from_port         = 443
#   to_port           = 443
#   protocol          = "tcp"
