...
# chmod lab2
# resource "aws_vpc_security_group_ingress_rule" "allow_my_ip_debug" {
#   security_group_id = aws_security_group.chewbacca_alb_sg01.id
#   description       = "Temp bypass for debugging"
#   from_port         = 80
#   to_port           = 80
#   ip_protocol       = "tcp"
#   cidr_ipv4         = "0.0.0.0/0" # Allow everyone briefly to prove connectivity
# }
# end
...
resource "aws_vpc_security_group_egress_rule" "alb_all_outbound" {
  security_group_id = aws_security_group.chewbacca_alb_sg01.id
  description       = "Allow ALB to talk to EC2 and respond to clients"
  ip_protocol       = "-1"          # -1 means ALL protocols
  cidr_ipv4         = "0.0.0.0/0"   # Allow response to the whole world
}
#end
...
resource "aws_secretsmanager_secret" "chewbacca_db_secret01" {
  name = "${local.name_prefix}/rds/mysql-v07"
  #change mod
  #   lifecycle {
