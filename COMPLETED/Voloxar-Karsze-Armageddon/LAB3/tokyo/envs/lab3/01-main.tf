...
module "security" {
  ...
  far_dest_cidr = try(data.terraform_remote_state.saopaulo.outputs.sao_vpc_cidr_block, var.sao_vpc_cidr_block)
...
source = "../../modules/tokyo_gateway"
  ...
  vpc_id    = module.vpc.vpc_id
  private_subnet_ids = module.vpc.private_subnet_ids
  #peer_transitgw_id = module.sao_paulo_gateway.peer_tgw_id

  peer_transitgw_id = try(data.terraform_remote_state.saopaulo.outputs.peer_tgw_id, "null")
  
  
  private_route_table_id = module.vpc.private_route_table_id
  #dest_cidr_block = var.sao_vpc_cidr_block

   dest_cidr_block = try(data.terraform_remote_state.saopaulo.outputs.sao_vpc_cidr_block, var.sao_vpc_cidr_block)
...
#moved the rest to sao paulo folder
###############LAB3: Sao Paulo##################################
################################################################
# # VPC / Network Module
...
# module sao_paulo_gateway {
# source = "../../modules/sao_paulo_gateway"
...
# module gateway_export {
# source = "../../modules/gateway_export"

#   region = var.sao_region
#   #lab3
#   tgw_attach_id = module.tokyo_gateway.tgw_attach_id
#   peer_tgw_id = module.sao_paulo_gateway.peer_tgw_id
#   sao_vpc_id = module.sao_vpc.vpc_id
