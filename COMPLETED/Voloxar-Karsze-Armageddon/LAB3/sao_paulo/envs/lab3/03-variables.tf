...
variable "sao_vpc_cidr_block" {
  description = "VPC cidr block"
  type = string
}

variable "sao_avail_zone_1" {
    description = "provider region, availability zone for resources"
    type = string
}

variable "sao_avail_zone_2" {
    description = "provider region, availability zone for resources"
    type = string
}

variable "sao_public_subnet_cidr" {
  description = "public subnet cidr range"
  type = string
}

variable "sao_public_subnet_cidr2" {
  description = "public subnet cidr range"
  type = string
}
...
variable "sao_private_subnet_cidr_1" {
  description = "private subnet cidr range"
  type = string
}

variable "sao_private_subnet_cidr_2" {
  description = "private subnet cidr range"
  type = string
}


variable "sao_rtb_public_cidr" {
  description = "route table public cidr"
  type = string
}

variable "sao_app_subdomain" {
  type = string
  default = "app2"
}