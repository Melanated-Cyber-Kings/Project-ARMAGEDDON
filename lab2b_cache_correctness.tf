...
data "aws_cloudfront_distribution" "chewbacca_cf01" {
  id = "E31RF6EL0C46DN"  # Your CloudFront distribution ID
}

# This will be merged into your existing distribution
# You need to update lab2_cloudfront_alb.tf with these behaviors
